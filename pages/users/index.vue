    ...
    <div class="space-y-2">
      <div v-for="member in members" :key="member.id" class="flex items-center justify-between border-b px-4 py-2">
        ...
        <div class="flex space-x-2">
          <NuxtLink :to="`/users/${member.id}`" class="bg-blue-500 text-white rounded-lg p-3 hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 transform hover:scale-105 transition-all duration-200 shadow-lg">
